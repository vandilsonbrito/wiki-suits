  ...
  return (
    <div className="w-full h-full text-white flex flex-col items-center pt-16 ">
            ...
            <div className="w-full pt-16 flex flex-col gap-5">
                ...
                <p className="">Na Pearson Hardman existem outros advogados como o Luis Litt e Jéssica Pearson, além de Donna Paulsen (Sarah Rafferty) que é secretária e Rachel Zane (Meghan Markle), paralegal são os personagens principais.</p>
            </div>
